...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/913a3c1edece68091d2ef.png 𝐇𝐞𝐥𝐥𝐨 𝐛𝐫𝐮𝐡 {sender}, 𝐊𝐑𝐀𝐓𝐎𝐒 𝐌𝐃 𝐢𝐬 𝐚𝐥𝐢𝐯𝐞 \n 𝐔𝐩𝐭𝐢𝐦𝐞: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '254102074064@s.whatsapp.net',
    ...
    ANTISPAM_COUNT: process.env.ANTISPAM_COUNT || '3/10', // msgs/sec
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐊𝐑𝐀𝐓𝐎𝐒 𝐌𝐃;𝐃𝚺𝐕𝐈𝐋 𝐃𝐑𝚺𝐗;0;https://telegra.ph/file/10e8ce3f497f418cee4c8.jpg;https://chat.whatsapp.com/LqYfmGAmfbnHhtSWSsXP1v',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',h
    STICKER_DATA: process.env.STICKER_DATA || "𝐊𝐑𝐀𝐓𝐎𝐒 𝐌𝐃",
    BOT_NAME: process.env.BOT_NAME || '𝐊𝐑𝐀𝐓𝐎𝐒 𝐌𝐃',
    ...
    SUDO: process.env.SUDO || "254102074064",
